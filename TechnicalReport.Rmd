...
```{r fig4, echo = FALSE, fig.cap="\\label{fig:fig4}Scree plot and Biplot", cache=TRUE }
...
### Fitting Regression and Bagged Models
Using counts
Using ratios
```{r}
set.seed(120)
...
4. Test Misclassification rate
>>>>>>> 3ffd6f555b95d0bc95adbf771386c749deb6b5e4
