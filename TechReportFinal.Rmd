---
title: "Yelp!"
author: "Claire Jellison and Jacob Goldsmith and Ryan Kobler"
date: "12/11/2019"
output: pdf_document
---
...
```{r fig1, eval=FALSE, fig.cap="\\label{fig:fig1}Distribution of the Response", cache=TRUE, include=FALSE}
...
```{r fig4, echo = FALSE, fig.cap="\\label{fig:fig4}Scree plot and Biplot", cache=TRUE, include=FALSE }
...
Here $\theta_i$ are the threshold values and $\mathbf w$ is the coefficient vector. For our $\sigma$ we chose the logistic function. 
